...
init() 
{
	...
	height = 199;
	//----------------------DEFAULT-------------------------
	addDesign("default",0,(0.3, 0.3, 0.3),0.6,"white",250,40,"middle",height);
	addDesign("default",1,(1, 0, 0),0.8,"nightvision_overlay_goggles",250,40,"middle",height);
	//-----------------------BLUE--------------------------
	addDesign("blue",0,(0, 0, 1),0.6,"white",250,40,"middle",height);
	addDesign("blue",1,(0, 0, 1),0.8,"nightvision_overlay_goggles",250,40,"middle",height);
	//-----------------------RED--------------------------
	addDesign("red",0,(1, 0, 0),0.6,"white",250,40,"middle",height);
	addDesign("red",1,(1, 0, 0),0.8,"nightvision_overlay_goggles",250,40,"middle",height);
	//-----------------------GREEN--------------------------
	addDesign("green",0,(0, 1, 0),0.6,"white",250,40,"middle",height);
	addDesign("green",1,(0, 1, 0),0.8,"nightvision_overlay_goggles",250,40,"middle",height);
	//-----------------------YELLOW--------------------------
	addDesign("yellow",0,(1, 1, 0),0.6,"white",250,40,"middle",height);
	addDesign("yellow",1,(1, 1, 0),0.8,"nightvision_overlay_goggles",250,40,"middle",height);
	//-----------------------Member--------------------------
	addDesign("member",0,(1, 1, 1),0.6,"playercard_emblem_4",255,50,"middle",height);
	addDesign("member",1,(1, 1, 1),0.6,"playercard_emblem_4",253,48,"middle",height);
	//------------------------VIP 1--------------------------
	addDesign("vip1",0,(1,1,1),0.5,"playercard_emblem_1",255,50,"middle",height);
    addDesign("vip1",1,(1,1,1),0.5,"playercard_emblem_1",253,48,"middle",height);
	//------------------------VIP 2--------------------------
	addDesign("vip2",0,(1,1,1),0.5,"playercard_emblem_2",250,45,"middle",height);
    addDesign("vip2",1,(1,1,1),0.5,"playercard_emblem_2",250,45,"middle",height);
	//------------------------VIP 3--------------------------
	addDesign("vip3",0,(1,0.5,0.5),0.5,"playercard_emblem_3",250,45,"middle",height);
    addDesign("vip3",1,(0.5,0.5,0.5),0.5,"playercard_emblem_3",250,45,"middle",height);
