...
getsongname(songnum)
{
	...
	switch(songnum)
	{
		case 1:	level.name = "XS Project Brostaj Dalbit";
		break;
		case 2:	level.name = "Futura - Jeephay";
		break;
		case 3:	level.name = "Lisa Pin-Up - Turn Up The Sound";
		break;
		case 4:	level.name = "Nobody knows";
		break;
		case 5:	level.name = "Russian Village Boys - Elephants Dick";
		break;
		case 6:	level.name = "Russian Village Boys - Cyka";
		break;
		case 7:	level.name = "DJ Armani - Miami";
		break;
		case 8:	level.name = "Iron Project - Jumper";
		break;
		case 9:	level.name = "Dj Raf - La Pumping Musica";
		break;
		case 10: level.name = "DJ Blyatman - Motherland";
		break;
		case 11: level.name = "Ludix - Lucas";
		break;
		case 12: level.name = "Jay Hardway - Run Baby Run";
		break;
		case 13: level.name = "Dr.Fresch - Take a step back";
		break;
		case 14: level.name = "Krewella - Alive";
		break;
		case 15: level.name = "Eauki - Nothing 2 Lose";
		break;
		case 16: level.name = "Dread Pitt Oceans - Boast";
		break;
		case 17: level.name = "Coldplay - Paradise (Fedde Remix)";
		break;
		case 18: level.name = "Mala Rejverka";
		break;
		case 19: level.name = "Frank Caro -Alemany MSV";
		break;
		case 20: level.name = "L19U1D x KORDHELL - I AM THE KING";
		break;
		case 21: level.name = "Septica - Odrezali su mi krivu nogu";
		break;
		case 22: level.name = "Free - All right now";
		break;
		case 23: level.name = "Thin Lizzy - The Boys Are Back In Town";	
        break;	
	    case 24: level.name = "Rage Against The Machine - Killing In the Name";	
        break;	
	    case 25: level.name = "Back Off Bitch - Guns n Roses";	
        break;	
	    case 26: level.name = "ABCDEF";	
        break;	
	    case 27: level.name = "GUSTAVO LIMA - TCHE TCHE RERE";	
        break;	
	    case 28: level.name = "Mi Mi Mi";	
        break;	
	    case 29: level.name = "Riton x Oliver Heldens - Turn Me On";	
        break;	
		case 30: level.name = "Farruko - Pepas";	
        break;	
	    case 31: level.name = "Maroon 5 - Moves Like Jagger";	
        break;	
	    case 32: level.name = "Arctic Monkeys - Crying Lightning";	
        break;	
	    case 33: level.name = "Gente de Zona - Poquito a Poco";	
        break;	
	    case 34: level.name = "VOX - Bananowy song";	
        break;	
		case 35: level.name = "Tame Impala - Let it Happen";	
        break;	
		case 36: level.name = "Tunak Tunak Tun - Daler Mehndi";	
        break;
		case 37: level.name = "Vatrogasci - Tika taka tika fak";	
        break;
		case 38: level.name = "Banda Furia Latina - Kulikitaka Ti";	
        break;
		case 39: level.name = "SandokanMc - Daj bombu";	
        break;
		case 40: level.name = "Steklovata - Novi God";	
        break;
		case 41: level.name = "Bosansko Kolo";	
        break;
		case 42: level.name = "DJANI X SINAN - E PA NEKA (MR. HYDDEN REMIX)";	
        break;
		case 43: level.name = "Fikret Dudevic Pike - Gucci i Dolce & Gabbana";	
        break;
		case 44: level.name = "MILKO KALAYDZHIEV - GSM";	
        break;
		case 45: level.name = "Gojko i Juzni Vetar - Neka peva ova kuca";	
        break;
		case 46: level.name = "Zelena Salata";	
        break;
		case 47: level.name = "Vasko Zabata";	
        break;
		case 48: level.name = "Milko Kalajdziev - Kade si batko";	
        break;
		case 49: level.name = "Welcome to Bulgaria";	
        break;
		case 50: level.name = "Mile Kitic - A tako bih te ostavio";	
        break;
		case 51: level.name = "Diplo x French Montana - Welcome to the party";	
        break;
		case 52: level.name = "Lil Nas X - MONTERO";	
        break;
		case 53: level.name = "Shadow Lady - DePaul Remix";	
        break;
		case 54: level.name = "Desren x M.I.M.E - Lost";	
        break;
		case 55: level.name = "KIŠA METAKA - BAUHAUS";	
        break;
		case 56: level.name = "I'm a King";	
        break;
		case 57: level.name = "Snavs - Pharaoh";	
        break;
		case 58: level.name = "Sandro Silva x Quintino - Epic";	
        break;
		case 59: level.name = "Yellow Claw - Love me till it hurts";	
        break;
		case 60: level.name = "M.I.M.E - Chapo";	
        break;
		case 61: level.name = "Florian Meindl - Cybertruck";	
        break;
		case 62: level.name = "DJ Haus - Rhythm Division";	
        break;
		case 63: level.name = "Roll Dann - When The Hate Goes Away";	
        break;
		case 64: level.name = "Tune Up - Feel Fine";	
        break;
		case 65: level.name = "Roll Dann - The Club";	
        break;
		case 66: level.name = "Maurice - This Is Acid";	
        break;
		case 67: level.name = "Headhunterz - Oxygen";	
        break;
		case 68: level.name = "Rikhter - DD3 RIK4";	
        break;
		case 69: level.name = "On the Corner";	
        break;		
		case 70: level.name = "NuBass - Dodge This";	
        break;		
	}	
}
