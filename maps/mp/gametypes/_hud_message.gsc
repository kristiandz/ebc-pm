...
hintMessage( hintText )
{
	...
	notifyData.glowColor = (0.2, 0.2, 0.5);
...
initNotifyMessage()
{
	...
	self.notifyTitle.glowColor = (0.2, 0.2, 0.6); // 0.6, 0.2, 0.2
...
teamOutcomeNotify( winner, isRound, endReasonText, delay )
{
	...
	else if ( isDefined( self.pers["team"] ) && winner == team )
	{
		...
		outcomeTitle.color = (0.2, 0.2, 0.6);
	}
	else
	{
		outcomeTitle.glowColor = (0, 0, 0);
...
outcomeNotify( winner, endReasonText, delay )
{
	...
	firstTitle.glowColor = (0.2, 0.2, 0.6);
	...
	secondTitle.glowColor = (0.2, 0.2, 0.6);
	...
	thirdTitle setParent( secondTitle );
	thirdTitle.glowColor = (0.2, 0.2, 0.6);
