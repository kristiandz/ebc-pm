...
vehicle_80s_sedan1(color)
{
	...
	destructible_sound("fire_vehicle_flareup_med");destructible_loopsound("fire_vehicle_med");
	...
	destructible_sound("car_explode");destructible_explode(4000,5000,375,20,300);
	...
	tag="tag_glass_front";destructible_part(tag,"vehicle_80s_sedan1_glass_F",0);destructible_fx("tag_glass_front_fx","props/car_glass_large");
	destructible_sound("veh_glass_break_large");destructible_state(tag+"_d");
	tag="tag_glass_back";destructible_part(tag,"vehicle_80s_sedan1_glass_B",0);
	destructible_fx("tag_glass_back_fx","props/car_glass_large");destructible_sound("veh_glass_break_large");destructible_state(tag+"_d");
	tag="tag_glass_left_front";destructible_part(tag,"vehicle_80s_sedan1_glass_LF",0);destructible_fx("tag_glass_left_front_fx","props/car_glass_med");
	destructible_sound("veh_glass_break_large");destructible_state(tag+"_d");
	tag="tag_glass_right_front";destructible_part(tag,"vehicle_80s_sedan1_glass_RF",0);
	destructible_fx("tag_glass_right_front_fx","props/car_glass_med");destructible_sound("veh_glass_break_large");destructible_state(tag+"_d");
	tag="tag_glass_left_back";destructible_part(tag,"vehicle_80s_sedan1_glass_LB",0);destructible_fx("tag_glass_left_back_fx","props/car_glass_med");
	destructible_sound("veh_glass_break_large");destructible_state(tag+"_d");
	tag="tag_glass_right_back";destructible_part(tag,"vehicle_80s_sedan1_glass_RB",0);
	destructible_fx("tag_glass_right_back_fx","props/car_glass_med");destructible_sound("veh_glass_break_large");destructible_state(tag+"_d");
	tag="tag_light_left_front";destructible_part(tag,"vehicle_80s_sedan1_"+color+"_light_LF",20,undefined,undefined,undefined,0.5);
	destructible_fx(tag,"props/car_glass_headlight");destructible_sound("veh_glass_break_small");
...
vehicle_80s_wagon1(color)
{
	...
	destructible_loopsound("fire_vehicle_med");destructible_healthdrain(12,0.15);
	...
	destructible_fx("tag_death_fx","explosions/small_vehicle_explosion",false);
	destructible_sound("car_explode");destructible_explode(4000,5000,250,20,300);
	...
	tag="tag_glass_front";destructible_part(tag,"vehicle_80s_wagon1_glass_F",0);
	destructible_fx("tag_glass_front_fx","props/car_glass_large");
	destructible_sound("veh_glass_break_large");destructible_state(tag+"_d");
	tag="tag_glass_back";
	destructible_part(tag,"vehicle_80s_wagon1_glass_B",0);destructible_fx("tag_glass_back_fx","props/car_glass_large");
	destructible_sound("veh_glass_break_large");destructible_state(tag+"_d");
	tag="tag_glass_left_front";
	destructible_part(tag,"vehicle_80s_wagon1_glass_LF",0);destructible_fx("tag_glass_left_front_fx","props/car_glass_med");
	destructible_sound("veh_glass_break_large");destructible_state(tag+"_d");
	tag="tag_glass_right_front";destructible_part(tag,"vehicle_80s_wagon1_glass_RF",0);
	destructible_fx("tag_glass_right_front_fx","props/car_glass_med");
	destructible_sound("veh_glass_break_large");destructible_state(tag+"_d");
	tag="tag_glass_left_back";
	destructible_part(tag,"vehicle_80s_wagon1_glass_LB",0);destructible_fx("tag_glass_left_back_fx","props/car_glass_med");
	destructible_sound("veh_glass_break_large");destructible_state(tag+"_d");
	tag="tag_glass_right_back";destructible_part(tag,"vehicle_80s_wagon1_glass_RB",0);
	destructible_fx("tag_glass_right_back_fx","props/car_glass_med");destructible_sound("veh_glass_break_large");
	destructible_state(tag+"_d");
	tag="tag_glass_left_back2";destructible_part(tag,"vehicle_80s_wagon1_glass_LB2",0);
	destructible_fx("tag_glass_left_back2_fx","props/car_glass_med");
	destructible_sound("veh_glass_break_large");
	destructible_state(tag+"_d");
	tag="tag_glass_right_back2";destructible_part(tag,"vehicle_80s_wagon1_glass_RB2",0);
	...
	tag="tag_light_right_front";destructible_part(tag,"vehicle_80s_wagon1_"+color+"_light_RF",20,undefined,undefined,undefined,0.5);
	destructible_fx(tag,"props/car_glass_headlight");
	destructible_sound("veh_glass_break_small");
	...
	destructible_fx(tag,"props/car_glass_brakelight");destructible_sound("veh_glass_break_small"); 
