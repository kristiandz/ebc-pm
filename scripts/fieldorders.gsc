...
{					
	...
	player thread scripts\_missions::createChallenge();
}
...
{	
	...
	self.ui_fieldorders[0] setShader( "gradient_top", 150, 20 );
	...
	self.ui_fieldorders[1] setShader( "gradient_bottom", 150, 20 );
